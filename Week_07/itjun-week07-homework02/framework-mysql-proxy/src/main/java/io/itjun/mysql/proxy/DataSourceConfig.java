...
public class DataSourceConfig {
    ...
    public ShardingTableRuleConfiguration orderTableRuleConfig() {
        ShardingTableRuleConfiguration orderTableRuleConfig = new ShardingTableRuleConfiguration("t_order", "db${0..1}.t_order${0..1}");
    ...
    public DataSource shardingSphereDb() throws SQLException {
        ...
        return ShardingSphereDataSourceFactory.createDataSource(dataSourceMap, Collections.<RuleConfiguration>singleton(shardingRuleConfig()), new Properties());
    }
